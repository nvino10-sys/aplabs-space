...
function dsSetupSockets() {
  ...
  skt.on('game:warzoneJoined',function(d){DNOTIFY('WARZONE! '+d.players+' fighters. Gas: '+Math.round(d.gasRadius)+'u');dsGameWarzone={active:true};});
  skt.on('game:arenaState',function(d){
